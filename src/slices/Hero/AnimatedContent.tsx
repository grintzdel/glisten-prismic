  ...
  return (
    <div className="relative" ref={container}>
      ...
      {isFilled.image(slice.primary.image) && (
        <div className="hero__image glass-container mt-10 w-fit opacity-0">
          <div className="hero__glow absolute inset-0 -z-10 bg-yellow-300/60 opacity-0 blur-2xl filter" />
          <PrismicNextImage
